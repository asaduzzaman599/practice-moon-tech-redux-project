...
import { loadedOneProdcut } from "../../redux/actions/productAction";
import { addProductData } from "../../redux/thunk/products/add-product";
import { loadSIngleProductData } from "../../redux/thunk/products/fetch-products";
import { UpdateProductData } from "../../redux/thunk/products/update-product";
...
const UpdateProduct = () => {
  ...
  const {id} = useParams()
     const productdata = useSelector((s)=>s.products.product)
  useEffect(()=>{
    dispatch(loadSIngleProductData(id))
  },[]) 

  setValue('model',productdata.model)
